...
public class Fr_NewPasswordEmpleado extends JFrame {
	...
	/**  
	 * Valida que las contraseñas introducidas en ambos campos del formulario sean identicas y modifica las propiedades
	 * de los componentes ya sea  que coincidan o no.
	 * 
	 * @author PABLO
