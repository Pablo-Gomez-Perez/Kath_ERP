...
public class Fr_PuntoDeVentas extends JFrame {
	...
	private JComboBox cmbRfcCliente;
	...
	public Fr_PuntoDeVentas() {
		...
		panelSuperiorDatos.setBorder(new CompoundBorder(new LineBorder(new Color(0, 0, 0)), new EmptyBorder(5, 5, 5, 5)));
		...
		horizontalBox.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Datos de venta", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		btnBuscarVenta.setIcon(new ImageIcon(Fr_PuntoDeVentas.class.getResource("/com/kathsoft/kathpos/app/resources/buscar_ico.png")));
		...
		verticalBox.setBorder(new TitledBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)), "Atiende", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		verticalBox_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Cliente", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panelCentralContenedor.setBorder(new CompoundBorder(new EmptyBorder(5, 5, 5, 5), new LineBorder(new Color(0, 0, 0))));
		...
		verticalStrut_6 = Box.createVerticalStrut(300);
		...
		txfGranTotalVenta.setColumns(20);
