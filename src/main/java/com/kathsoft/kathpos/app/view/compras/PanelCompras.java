	...
	public PanelCompras() {
		...
		glPanelPrincipalContenedor.setHorizontalGroup(
			glPanelPrincipalContenedor.createParallelGroup(Alignment.LEADING)
				.addComponent(this.panelBotones, GroupLayout.DEFAULT_SIZE, 775, Short.MAX_VALUE)
				.addComponent(this.panelFiltros, GroupLayout.DEFAULT_SIZE, 775, Short.MAX_VALUE)
				.addGroup(glPanelPrincipalContenedor.createSequentialGroup()
					.addContainerGap()
					.addComponent(this.scrollPaneTablaCompras, GroupLayout.DEFAULT_SIZE, 751, Short.MAX_VALUE)
					.addContainerGap())
		);
		glPanelPrincipalContenedor.setVerticalGroup(
			glPanelPrincipalContenedor.createParallelGroup(Alignment.LEADING)
				.addGroup(glPanelPrincipalContenedor.createSequentialGroup()
					...
					.addComponent(this.scrollPaneTablaCompras, GroupLayout.DEFAULT_SIZE, 356, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(this.panelFiltros, GroupLayout.PREFERRED_SIZE, 105, GroupLayout.PREFERRED_SIZE))
		);
				...
				.addGroup(glPanelFiltros.createSequentialGroup()
					...
					.addGroup(glPanelFiltros.createParallelGroup(Alignment.LEADING)
						.addGroup(glPanelFiltros.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(this.cmbProveedor, 0, 260, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(this.lblFolioFactura)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(this.txfFolioFactura, GroupLayout.DEFAULT_SIZE, 235, Short.MAX_VALUE))
						.addGroup(glPanelFiltros.createSequentialGroup()
							.addComponent(this.lblFechaFacturaInicio)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(this.txfFechaFacturaInicio, GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(this.lblFechaFacturaFin)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(this.txfFechaFacturaFin, GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(this.lblTipoCompra)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(this.cmbTipoCompra, 0, 135, Short.MAX_VALUE))
						.addGroup(Alignment.TRAILING, glPanelFiltros.createSequentialGroup()
