 ...
 */
public record CuentaContableFormDetails(int idCuenta, int idCuentaPadre, int fkIdRubro, int fkIdGrupoContable,String clave, String nombre,
		String descripcion, short nivel, boolean esUltimoNivel) {
